...
→ What best practices can we adapt from adjacent domains?
...
→ What can we simplify or minimize to improve user experience?
...
3. Do not filter or judge during ideation — capture everything
4. Write down every idea, even seemingly impractical ones
5. After completing all 7, review and select the most promising concepts
6. Combine multiple SCAMPER ideas for novel solutions

Wild ideas often surface breakthrough innovations.

Output this session to: bmad-output/brainstorm-scamper.md
